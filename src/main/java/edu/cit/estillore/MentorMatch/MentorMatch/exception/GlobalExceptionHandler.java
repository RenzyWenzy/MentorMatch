package edu.cit.estillore.MentorMatch.MentorMatch.exception;

import edu.cit.estillore.MentorMatch.MentorMatch.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    /** Thrown by UserServiceImpl for duplicate emails, password mismatch, missing role fields, etc. */
